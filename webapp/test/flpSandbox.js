		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comerosstockavailability-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comerosstockavailability-display": {
								"semanticObject": "comerosstockavailability",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.eros.stockavailability",
									"url": sap.ui.require.toUrl("com/eros/stockavailability")
								}
							}
						}
					}
